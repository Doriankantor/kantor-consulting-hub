      ...
      <div className="max-w-2xl">
        ...
        {isAdmin && (
          <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-5 mb-6">
            <h2 className="text-sm font-semibold text-white/80 mb-1">Invite a team member</h2>
            ...
            <form onSubmit={handleInvite} className="flex gap-2">
              <input
                ...
                className="titlebar-no-drag flex-1 px-3.5 py-2 rounded-xl bg-black/20 border border-white/[0.1] text-white placeholder-white/25 text-sm focus:outline-none focus:ring-2 focus:ring-hub-gold/40 focus:border-hub-gold/40 transition"
              />
              <button
                type="submit"
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl overflow-hidden">
          <div className="px-5 py-3 border-b border-white/[0.06]">
            <h2 className="text-[10px] font-semibold text-white/30 uppercase tracking-widest">Members</h2>
          </div>
                  ...
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {member.id === user?.id && (
                          <span className="text-[10px] text-white/25 font-medium">(you)</span>
                        )}
                      </div>
                      <p className="text-xs text-white/35 mt-0.5">{member.email}</p>
                    </div>
                  </div>
