...
const api = {
  ...
  personalTodo: {
    ...
    clearMissed: (id: string, date: string) => ipcRenderer.invoke('personalTodo:clearMissed', id, date),
  },
  ...
  publication: {
    ...
    getIncidentBySource: (articleId: string) => ipcRenderer.invoke('publication:getIncidentBySource', articleId),
    ...
    acceptProposal: (input: { article_id: string; info_page: string; geography: string; section_key: string; before_body: string | null; after_body: string; divergence: boolean; divergence_reasoning: string | null }) => ipcRenderer.invoke('publication:acceptProposal', input),
    keepProposal: (input: { article_id: string; info_page: string; geography: string; section_key: string }) => ipcRenderer.invoke('publication:keepProposal', input),
  ...
  intelligence: {
    ...
    updateActors:         (id: string, actors: { name: string; type: string }[]) => ipcRenderer.invoke('intelligence:updateActors', id, actors),
    ...
    setIncidentFlag:      (id: string, value: boolean | null) => ipcRenderer.invoke('intelligence:setIncidentFlag', id, value),
    ...
    getPipelineStats:     (project?: string)                 => ipcRenderer.invoke('intelligence:getPipelineStats', project),
