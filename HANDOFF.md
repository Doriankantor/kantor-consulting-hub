...
▶ RESUME HERE -> P4c-1 done. Next candidates, in order:
  (a) P4c-2 (card-proposal review render + accept): surface proposed_cards[] in the review canvas
      ...
      eviction picker; capture publication_changes with action='card'. WATCH card volume/repetition
      per the KNOWN TUNING LEVER note above -- decide propose-breadth tuning with the screen in front of us.
